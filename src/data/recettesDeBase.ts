...
export const ingredientsDeBase: Ingredient[] = [
  ...
  { id: 'huile', nom: 'Huile', categorie: 'autre', unite: 'càs' },
  ...
  { id: 'fromage', nom: 'Fromage', categorie: 'produit laitier', unite: 'tranche' },
  ...
  { id: 'sucre', nom: 'Sucre', categorie: 'autre', unite: 'pot' },
  { id: 'farine', nom: 'Farine', categorie: 'féculent', unite: 'pot' },
  ...
  { id: 'miel', nom: 'Miel', categorie: 'autre', unite: 'càs' },
  ...
  // Ajouts pour un placard/frigo complet :
