...
export const ingredientsDeBase: Ingredient[] = [
  ...
  { id: 'ail', nom: 'Ail', categorie: 'légume', unite: 'gousse' },
  ...
  { id: 'jambon', nom: 'Jambon', categorie: 'viande', unite: 'tranche' },
  ...
  { id: 'jambon-blanc', nom: 'Jambon blanc', categorie: 'viande', unite: 'tranche' },
  ...
  { id: 'yaourt', nom: 'Yaourt', categorie: 'produit laitier', unite: 'pot' },
  ...
  { id: 'pain', nom: 'Pain', categorie: 'féculent', unite: 'tranche' },
  { id: 'pain-de-mie', nom: 'Pain de mie', categorie: 'féculent', unite: 'tranche' },
  { id: 'semoule', nom: 'Semoule', categorie: 'féculent', unite: 'g' },
  { id: 'pate-brisee', nom: 'Pâte brisée', categorie: 'féculent', unite: 'rouleau' },
  ...
  { id: 'pate-a-pizza', nom: 'Pâte à pizza', categorie: 'féculent', unite: 'rouleau' },

  // === ÉPICES & HERBES ===
  { id: 'persil', nom: 'Persil', categorie: 'épice', unite: 'pincée' },
  { id: 'herbes', nom: 'Herbes', categorie: 'épice', unite: 'pincée' },
  { id: 'menthe', nom: 'Menthe', categorie: 'épice', unite: 'pincée' },
  { id: 'sel', nom: 'Sel', categorie: 'épice', unite: 'g' },
  { id: 'poivre', nom: 'Poivre', categorie: 'épice', unite: 'g' },
  { id: 'thym', nom: 'Thym', categorie: 'épice', unite: 'pincée' },
  { id: 'romarin', nom: 'Romarin', categorie: 'épice', unite: 'pincée' },
  { id: 'basilic', nom: 'Basilic', categorie: 'épice', unite: 'pincée' },
  { id: 'oregano', nom: 'Orégano', categorie: 'épice', unite: 'pincée' },
  { id: 'paprika', nom: 'Paprika', categorie: 'épice', unite: 'pincée' },
  { id: 'cumin', nom: 'Cumin', categorie: 'épice', unite: 'pincée' },
  { id: 'curry', nom: 'Curry', categorie: 'épice', unite: 'pincée' },
  { id: 'cannelle', nom: 'Cannelle', categorie: 'épice', unite: 'pincée' },
  { id: 'aneth', nom: 'Aneth', categorie: 'épice', unite: 'pincée' },
  { id: 'herbes-de-provence', nom: 'Herbes de Provence', categorie: 'épice', unite: 'pincée' },
  { id: 'gingembre', nom: 'Gingembre', categorie: 'épice', unite: 'pincée' },

  // === AUTRES ===
  { id: 'huile', nom: 'Huile', categorie: 'autre', unite: 'ml' },
  { id: 'vinaigrette', nom: 'Vinaigrette', categorie: 'autre', unite: 'càs' },
  ...
  { id: 'levure', nom: 'Levure', categorie: 'autre', unite: 'sachet' },
  { id: 'vinaigre', nom: 'Vinaigre', categorie: 'autre', unite: 'ml' },
  { id: 'moutarde', nom: 'Moutarde', categorie: 'autre', unite: 'càs' },
  { id: 'ketchup', nom: 'Ketchup', categorie: 'autre', unite: 'càs' },
  { id: 'mayonnaise', nom: 'Mayonnaise', categorie: 'autre', unite: 'càs' },
  { id: 'chocolat', nom: 'Chocolat', categorie: 'autre', unite: 'g' },
  { id: 'cacao', nom: 'Cacao', categorie: 'autre', unite: 'g' },
  { id: 'cafe', nom: 'Café', categorie: 'autre', unite: 'càs' },
  { id: 'the', nom: 'Thé', categorie: 'autre', unite: 'sachet' },
...
export const recettesDeBase: Recette[] = [
  ...
  },
  {
    ...
    ingredients: [
      { ingredientId: 'pate-a-pizza', quantite: 1, unite: 'rouleau' },
      { ingredientId: 'tomate', quantite: 3, unite: 'pièce' },
      { ingredientId: 'mozzarella', quantite: 250, unite: 'g' },
      { ingredientId: 'basilic', quantite: 1, unite: 'pincée' },
      { ingredientId: 'huile', quantite: 2, unite: 'càs' },
      { ingredientId: 'sel', quantite: 1, unite: 'pincée' },
    ],
    etapes: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { ingredientId: 'curry', quantite: 2, unite: 'pincée' },
      { ingredientId: 'ail', quantite: 2, unite: 'gousse' },
      { ingredientId: 'gingembre', quantite: 1, unite: 'pincée' },
      { ingredientId: 'oignon', quantite: 1, unite: 'pièce' },
      { ingredientId: 'huile', quantite: 2, unite: 'càs' },
    ],
    etapes: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { ingredientId: 'oignon', quantite: 1, unite: 'pièce' },
      { ingredientId: 'ail', quantite: 3, unite: 'gousse' },
      { ingredientId: 'huile', quantite: 4, unite: 'càs' },
      { ingredientId: 'herbes-de-provence', quantite: 1, unite: 'pincée' },
      { ingredientId: 'sel', quantite: 1, unite: 'pincée' },
      { ingredientId: 'poivre', quantite: 1, unite: 'pincée' },
    ],
    etapes: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { ingredientId: 'oeuf', quantite: 1, unite: 'pièce' },
      { ingredientId: 'ail', quantite: 1, unite: 'gousse' },
      { ingredientId: 'mayonnaise', quantite: 3, unite: 'càs' },
      { ingredientId: 'citron', quantite: 1, unite: 'pièce' },
      { ingredientId: 'huile', quantite: 2, unite: 'càs' },
    ],
    etapes: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { ingredientId: 'miel', quantite: 2, unite: 'càs' },
      { ingredientId: 'gingembre', quantite: 1, unite: 'pincée' },
      { ingredientId: 'ail', quantite: 2, unite: 'gousse' },
      { ingredientId: 'huile', quantite: 2, unite: 'càs' },
    ],
